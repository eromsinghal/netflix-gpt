...
import { BG_URL, USER_AVETAR } from '../utils/constants';
  ...
  return (
    <div>
      ...
      <div className="absolute">
        <img  className ="min-h-screen flex flex-col  md:h-[100%] " src={BG_URL}
        alt='logo' />
      </div>
      <form onSubmit={(e) => e.preventDefault()} className="w-full md:w-4/12 absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80">
        ...
        <input
          ref={email} type="text" placeholder="Email Address" className="p-4 my-4 w-full bg-gray-700" />
